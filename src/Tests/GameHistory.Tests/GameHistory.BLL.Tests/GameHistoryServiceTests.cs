...
namespace GameHistory.BLL.Tests
{
    public class GameHistoryServiceTests
    {
        ...
        public void GetAllGameHistories_RequestMessageMayBeEmpty_ReturnTrue()
        {
            ...
            //Arrange
            _mock.Setup(x => x.GetAllGameHistories(gameHistoryRequest).Result).Returns(fakeGameHistories);

            //Act
            var result = _mock.Object.GetAllGameHistories(gameHistoryRequest).Result.ToList();
        ...
        public void GetAllGameHistories_Should_Return_Reverse_List()
        {
            ...
            _mock.Setup(x => x.GetAllGameHistories(gameHistoryRequest).Result).Returns(getHistoryListResponse);

            //Act
            var result = _mock.Object.GetAllGameHistories(gameHistoryRequest).Result;
